  ...
  return (
    <div className="relative w-full min-w-[10rem] max-w-[11rem] sm:max-w-xs">
      ...
      <input
        ...
        className="h-8 w-full min-w-0 rounded-lg border border-gray_200 bg-white py-1 pl-9 pr-3 text-xs text-gray_900 placeholder:text-gray_500 dark:border-gray_600 dark:bg-gray_800 dark:text-gray_100 dark:placeholder:text-gray_500"
      />
    </div>
  )
}
