  ...
  const snapshot = useMemo(
    () =>
      buildDashboardReportSnapshot({
        ...
        s3UnencryptedBuckets: summary.s3UnencryptedBuckets,
        lambdaPublicFunctions: summary.lambdaPublicFunctions,
        acmExpiringCertificates: summary.acmExpiringCertificates,
        ec2UnusedSecurityGroups: summary.ec2UnusedSecurityGroups,
        ec2UnattachedVolumes: summary.ec2UnattachedVolumes,
    ...
    [
      ...
      summary.s3UnencryptedBuckets,
      summary.lambdaPublicFunctions,
      summary.acmExpiringCertificates,
      summary.ec2UnusedSecurityGroups,
      summary.ec2UnattachedVolumes,
      summary.scans,
